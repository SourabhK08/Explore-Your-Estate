...
const chapters = [
  {
    ...
    description:
      "Most real estate projects begin with strong vision, but lack clarity, differentiation, and a compelling market narrative.",
  ...
  },
  {
    ...
    description:
      "EYE decodes location signals, buyer intent, and competitor positioning to uncover your project's true market advantage.",
  ...
  },
  {
    ...
    description:
      "We translate strategy into high-impact 3D visuals and storytelling that help buyers emotionally connect before they visit.",
  ...
  },
  {
    ...
    description:
      "Targeted campaigns, funnels, and content convert attention into qualified leads and site visits.",
    sub: "SALES ACCELERATION",
    metrics: "+3.2x Engagement • -42% Cost per Lead"
  },
  {
    title: "The Result",
    description:
...
export default function CaseStories2() {
  ...
  const overlayOpacity = useTransform(scrollYProgress, [0, 0.2, 0.8, 1], [0.8, 0.4, 0.2, 0.6]);

  return (
    <div ref={targetRef} className="relative h-[500vh] bg-black">
      {/* FIXED CANVAS CONTAINER */}
      <BackgroundEffects/>
<p>THE EYE METHOD — OUTCOME</p>
<p>This is not a single case study. <br />This is the transformation every EYE-led project goes through.</p>
               ...
               return (
                 ...
                 >
                   <div className="flex items-center gap-3 mb-6">
                      ...
                      <span className="text-[#10a1fd] font-mono tracking-[0.4em] text-xs uppercase">{chapter.sub}</span>
                   </div>
          ...
          <div className="hidden lg:flex flex-col justify-center items-end">
            ...
            >
              <div className="flex gap-12 text-right">
                <div>
                  <p className="text-[10px] font-mono text-white/30 uppercase mb-2">Signal Status</p>
                  <p className="text-[#10a1fd] font-bold">OPTIMIZED</p>
                </div>
                <div>
                  <p className="text-[10px] font-mono text-white/30 uppercase mb-2">Process Mode</p>
                  <p className="text-white font-bold tracking-tighter uppercase">Cinematic Flow</p>
                </div>
              </div>
            </motion.div>
          </div>
