    ...
    <section className="py-24 bg-black overflow-hidden">
      <div className="px-6 mb-16 container mx-auto text-center">
        <motion.span
          ...
          className="text-[#0a4c84] font-mono tracking-[0.3em] uppercase text-sm block mb-4"
        >
          Our Services
        </motion.span>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 pb-2 px-6 no-scrollbar">
        {services.map((service, i) => (
          <motion.div
            ...
            className="min-w-[300px] bg-[#0a4c84]/5 border border-[#e6e6e6]/10 p-10 rounded-[2rem] snap-center group relative overflow-hidden"
          >
            <div className="absolute top-0 right-0 p-8 text-6xl font-bold text-[#0a4c84]/10 group-hover:text-[#0a4c84]/20 transition-colors">
              {service.id}
            </div>
            ...
            <div className="w-12 h-[2px] bg-[#0a4c84] group-hover:w-full transition-all duration-500" />
          </motion.div>
        ))}
      </div>
    </section>
