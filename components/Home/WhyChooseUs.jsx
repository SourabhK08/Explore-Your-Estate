        ...
        <div className="flex flex-col lg:flex-row gap-16 items-center">
          ...
          <div className="lg:w-1/2">
            <h2 className="text-[#e6e6e6] text-4xl md:text-5xl font-bold mb-8 leading-tight">
              ...
              <span className="text-[#0a4c84]">Choose EYE</span> [cite: 41]
            </h2>
          ...
          >
            <div className="absolute inset-0 bg-[#0a4c84]/20 blur-[100px] group-hover:bg-[#0a4c84]/30 transition-all rounded-full" />
            <div className="relative border border-[#e6e6e6]/10 bg-black/40 backdrop-blur-xl p-10 rounded-[40px]">
                <div className="text-[#e6e6e6] space-y-6">
                    <div className="flex justify-between items-center border-b border-[#e6e6e6]/10 pb-4">
                        ...
                        <CheckCircle2 className="text-[#0a4c84]" size={20} />
                    </div>
                    <div className="space-y-2">
                        <p className="text-5xl font-bold">20x</p>
                        <p className="text-[#0a4c84] font-bold tracking-widest uppercase text-sm">Lead Generation Boost</p>
                    </div>
                    <p className="text-[#e6e6e6]/40 text-sm italic">
                        "EYE is not just a service provider—we are your creative growth partner[cite: 48]."
                    </p>
                    <button className="w-full py-4 bg-[#e6e6e6] text-black font-bold rounded-2xl hover:bg-[#0a4c84] hover:text-[#e6e6e6] transition-colors">
                        Read Case Stories
                    </button>
                </div>
            </div>
