      ...
      <div className="container mx-auto grid lg:grid-cols-2 gap-20 items-center">
        ...
        >
          ...
          <p className="text-[#e6e6e6]/60 text-xl mt-8 leading-relaxed max-w-xl">
            At Explore Your Estate (EYE), we help real estate companies
            transform their projects into powerful visual stories. From
            high-impact 3D visuals to targeted digital campaigns, we ensure your
            brand doesn’t just exist it thrives.
          </p>
        ...
        <motion.div
          ...
          transition={{ duration: 0.6 }}
          className="w-full max-w-xl mx-auto rounded-3xl overflow-hidden border border-white/10"
        >
          <Image
            src="/about/1.jpeg"
